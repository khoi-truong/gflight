...
| [porting.md](porting.md) | in progress (M1 done; M2–M5 pending) | [#3](https://github.com/khoi-truong/gflight/pull/3) | Port a real Google Flights client: `FlightsFrontendService` RPC, stdlib-only, fixture-driven |
