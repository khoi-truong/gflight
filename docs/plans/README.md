...
| [porting.md](porting.md) | in progress (M1, M2, M3 done; M4–M5 pending) | [#3](https://github.com/khoi-truong/gflight/pull/3) | Port a real Google Flights client: `FlightsFrontendService` RPC, stdlib-only, fixture-driven |
